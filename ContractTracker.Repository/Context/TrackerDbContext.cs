...
namespace ContractTracker.Repository.Context
{
    public class TrackerDbContext : DbContext, IDisposable
    {
        ...
        public DbSet<ContractUsers> ContractPersons => Set<ContractUsers>();
        ...
        public DbSet<ContractUsers> ContractUsers => Set<ContractUsers>();
        public DbSet<ContractUserTypes> ContractUserTypes => Set<ContractUserTypes>();
